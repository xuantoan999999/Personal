...
var HttpService = (function () {
    function HttpService(http) {
        this.http = http;
        this.url = __WEBPACK_IMPORTED_MODULE_2__boostrap_config__["a" /* default */].getConfigs().url;
    }
    HttpService.prototype.get = function (method, id) {
        if (id === void 0) { id = null; }
        var urlString = this.convertUrl(method, id);
        return this.http.get(urlString)
            .map(function (response) { return response.json(); });
    };
    HttpService.prototype.post = function (data, method, id) {
        if (id === void 0) { id = null; }
        var urlString = this.convertUrl(method, id);
        return this.http.post(urlString, data)
            .map(function (response) { return response.json(); });
    };
    HttpService.prototype.convertUrl = function (method, id) {
        var urlString = this.url + "/" + method;
        if (id) {
            urlString += "/" + id;
        }
        return urlString;
