...
// Orders controller
angular.module('orders').controller('OrdersAddController', ['$rootScope', '$scope', '$log', '$stateParams', '$location', 'Authentication', 'Orders', 'Option', 'Notice', '$timeout', 'localStorageService',
