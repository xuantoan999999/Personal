...
angular.module('core').factory("Option", function ($rootScope) {
    ...
    const orderStatuses = [
        { name: 'Đơn hàng mới', value: 'NEW', class_color: 'label-default' },
        { name: 'Đặt hàng thành công', value: 'SUCCESS', class_color: 'label-primary' },
        { name: 'Đang đợi xử lý', value: 'PROCCESS', class_color: 'label-warning' },
        { name: 'Hàng đã đến đại lý', value: 'GO', class_color: 'label-info' },
        { name: 'Hoàn thành', value: 'FINISH', class_color: 'label-success' },
    ];

    const payment_methods = [
        { name: 'COD', value: 'COD' },
        { name: 'Thanh toán online', value: 'ONLINE' },
        { name: 'Chuyển khoản', value: 'CK' },
    ];

    var statuses = [{ name: "Publish", value: 1 }, { 'name': "Unpublish", value: 0 }, { name: "Trash", value: 2 }];
    var status_default = [{ name: "Publish", value: 1 }, { 'name': "Unpublish", value: 0 }];
    ...
    var typeCar = [{ name: 'new', value: 'Mới' }, { name: 'old', value: 'Cũ' }];
