...
var ApplicationConfiguration = (function () {
    ...
    var applicationModuleVendorDependencies = ['ngResource', 'ngAnimate', 'ui.router', 'ui.bootstrap', 'angularFileUpload', 'ui.select', 'ngSanitize', 'ngMessages', 'ui.utils.masks', 'ui.bootstrap.datetimepicker', 'ng.jsoneditor', 'ngFileUpload', 'LocalStorageModule', 'ui.tinymce', 'toastr'];
...
angular.module(ApplicationConfiguration.applicationModuleName).config(['$locationProvider', '$httpProvider', 'toastrConfig',
    function ($locationProvider, $httpProvider, toastrConfig) {
        ...
        angular.extend(toastrConfig, {
            ...
            target: 'body',
            templates: {
                toast: '/templates/portal-core/toast.html',
                progressbar: '/templates/portal-core/progressbar.html'
            }
        });
    }
    ]);
