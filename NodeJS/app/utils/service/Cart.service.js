							...
							redisClient.get(sessionUser.id_cart, function (err, resp) {
								...
								let setDetailProduct = function (index = 0) {
									if (index == cart.items.length)
										...
										query.select('name slug qty_in_stock category price images thumb view_unit id_unit id_promotion due_date active');
										query.populate('id_unit category').populate(productUtil.popuIdPromo());
