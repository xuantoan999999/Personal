...
gulp.task('site-concat-minfile', () => {
	...
	/*gộp file JS*/
	gulp.src(['./public/assets/frontend/javascripts/app.js', './public/dist/site/scripts/vendor.min.js', './public/dist/site/scripts/main.min.js', './public/dist/site/scripts/fix.js'])
