...
// Orders controller
angular.module('orders').controller('OrdersEditController', ['$rootScope', '$scope', '$log', '$stateParams', '$location', 'Authentication', 'Orders', 'Option', 'Notice', '$timeout', 'localStorageService',

    function ($rootScope, $scope, $log, $stateParams, $location, Authentication, Orders, Option, Notice, $timeout, localStorageService) {
